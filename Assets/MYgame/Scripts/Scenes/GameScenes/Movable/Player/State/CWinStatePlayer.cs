...
public class CWinStatePlayer : CPlayerStateBase
{
    ...
    protected override void InState()
    {
        ...
        m_MyPlayerMemoryShare.m_AllObj.transform.DOLocalRotate(new Vector3(0.0f, -360.0f, 0.0f), lTempRotateTime, RotateMode.LocalAxisAdd);
      ...
      //  TempSequence.AppendInterval(0.5f);
        TempSequence.Append(m_MyPlayerMemoryShare.m_BuffAnkleLSkateboard.DOLocalMoveY(-2.0f, lTempRotateTime * 0.5f).SetEase(Ease.Linear));
